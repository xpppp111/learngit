				...
				<div id="headright">
					<table border="0">
						<tr>
							...
							<td class="STYLE1"><img src="images/cart.gif" width="21"
								height="18" /> <a href="cart.jsp">购物车</a></td>
			...
			<div id="left">
				...
				<form name="form1" action="LoginServlet" method="post"
					...
					<table>
						...
						<tr>
							<td>密&nbsp;&nbsp;码:</td>
							<td><input type="password" name="userpass" size="22">
							</td>
						</tr>
