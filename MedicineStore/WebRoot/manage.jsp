  ...
  <tr>
    ...
    <td><div align="center"><a href="usermanage1.jsp"><b>我的资料</b></a></div></td>
		  ...
		  <div id="left">
				...
				<br />
				<center>
					<span class="form_row STYLE2"><a href="usermanage.jsp">用户管理</a>
					</span>
				</center>
				<br />
				<center>
					<span class="form_row STYLE2"><a href="goodmanage.jsp">商品管理</a>
					</span>
				</center>

			<p>&nbsp;</p>
				<p>　　　　　　　　　　　<a href="ordermanage.jsp" class="STYLE2">订单管理</a></p>
				<p>&nbsp;</p>
				<p>　　　　　　　　　　　<a href="Sum.jsp" class="STYLE2">销售统计</a></p>
				<p><br />
		    </p>
		  </div>
			<div id="right">
